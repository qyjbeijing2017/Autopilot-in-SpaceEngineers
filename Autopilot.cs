    ...
    partial class Program
    {
        public class Autopilot : Behavior
        {
            ...
            private TrustCombine forceOnDirection(Vector3 direction)
            {
                ...
                {
                    var forceCoefficient = Vector3.Dot(direction, trust.GridThrustDirection);
            ...
            IEnumerator FastUntilAttive(Vector3D target)
            {
                ...
                program.Echo($"forceDir {forceDir.X}, {forceDir.Y}, {forceDir.Z}");
                do
                {
                ...
                controlGyros = false;
                program.Echo($"error: {distance.Length()}");
            }
